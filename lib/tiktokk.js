...
const titoko = `https://xtream-api.herokuapp.com/downloader/tiktoknowm?link=${url}`
const tikitoko = `https://xtream-api.herokuapp.com/converter/tomp3?url=https://xtream-api.herokuapp.com/downloader/tiktoknowm?link=${url}`
const obj = {
	videoInfo: {
		id: ingfo.id,
		desc: ingfo.text,
