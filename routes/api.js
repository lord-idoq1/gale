...
fetch(encodeURI(`https://api-idoganz1.herokuapp.com/api/downloader/scdl?linkl=${link}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({             
...
const link = req.query.link
  const apikey = req.query.apikey;
      ...
      limitAdd(apikey);
  if(!link) return res.json({creator: 'idoganz', status: true, message: 'masukan parameter link'})
fetch(encodeURI(`https://api-idoganz1.herokuapp.com/api/downloader/tiktok?link=${link}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({             
...
const link = req.query.link
  const apikey = req.query.apikey;
      ...
      limitAdd(apikey);
  if(!link) return res.json({creator: 'idoganz', status: true, message: 'masukan parameter link'})
fetch(encodeURI(`https://api-idoganz1.herokuapp.com/api/downloader/pindl?link=${link}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({             
