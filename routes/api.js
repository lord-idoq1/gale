...
fetch(encodeURI(`https://api-idoganz1.herokuapp.com/api/scdl?linkl=${link}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({             
...
const link = req.query.link
  const apikey = req.query.apikey;
      ...
      limitAdd(apikey);
  if(!link) return res.json({creator: 'idoganz', status: true, message: 'masukan parameter link'})
fetch(encodeURI(`https://api-idoganz1.herokuapp.com/api/tiktok?link=${link}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({             
...
fetch(encodeURI(`https://hardianto-chan.herokuapp.com/api/tiktok?url=${url}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({             
...
const link = req.query.link
  const apikey = req.query.apikey;
      ...
      limitAdd(apikey);
  if(!link) return res.json({creator: 'idoganz', status: true, message: 'masukan parameter link'})
fetch(encodeURI(`https://api-idoganz1.herokuapp.com/api/pindl?link=${link}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({             
...
router.get('/stickerpack', async(req, res, next) => {
const link = req.query.link
  const apikey = req.query.apikey;
        if (apikey === undefined) return res.status(404).send({
            status: 404,
      ...
      limitAdd(apikey);
  if(!link) return res.json({creator: 'idoganz', status: true, message: 'masukan parameter link'})
fetch(encodeURI(`https://api-idoganz1.herokuapp.com/api/stickerpack?link=${link}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({             
